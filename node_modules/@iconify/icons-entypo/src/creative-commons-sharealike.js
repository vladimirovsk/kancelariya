let data = {
	"body": "<path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M9.988.4c-2.66 0-4.91.928-6.753 2.784C1.345 5.104.4 7.376.4 10s.945 4.88 2.835 6.768c1.89 1.888 4.142 2.832 6.753 2.832c2.643 0 4.934-.952 6.872-2.856c1.827-1.808 2.74-4.056 2.74-6.744s-.93-4.96-2.788-6.816C14.954 1.328 12.68.4 9.988.4zm.024 1.728c2.179 0 4.029.768 5.55 2.304C17.102 5.952 17.87 7.808 17.87 10c0 2.208-.752 4.04-2.258 5.496c-1.586 1.568-3.453 2.352-5.6 2.352c-2.146 0-3.996-.776-5.55-2.328C2.907 13.968 2.13 12.128 2.13 10c0-2.128.785-3.984 2.355-5.568c1.506-1.536 3.348-2.304 5.527-2.304z\" fill=\"currentColor\"/><path d=\"M5.733 8.645c.383-2.415 2.083-3.707 4.214-3.707c3.064 0 4.932 2.225 4.932 5.19c0 2.893-1.987 5.141-4.98 5.141c-2.06 0-3.903-1.267-4.238-3.754h2.418c.072 1.291.91 1.746 2.107 1.746c1.365 0 2.251-1.268 2.251-3.205c0-2.033-.766-3.109-2.203-3.109c-1.054 0-1.963.383-2.155 1.698l.703-.004l-1.903 1.904L4.975 8.64l.758.004z\" fill=\"currentColor\"/>",
	"width": 20,
	"height": 20
};
export default data;
